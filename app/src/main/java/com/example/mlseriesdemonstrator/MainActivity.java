...
//          startActivity(intent);
        ...
        arrayList.add(new Algo(R.drawable.audio, "Audio Classification", AudioClassificationActivity.class));
        arrayList.add(new Algo(R.drawable.bird, "Bird Sound Identifier", BirdSoundDetectorActivity.class));
        arrayList.add(new Algo(R.drawable.spam, "Spam Text Detector", SpamTextDetectionActivity.class));
      //  arrayList.add(new Algo(R.drawable.baseline_time_to_leave_black_48, "Driver Drowsiness Detector", DriverDrowsinessDetectionActivity.class));
        arrayList.add(new Algo(R.drawable.pose, "Pose Detection", PoseDetectionActivity.class));
     ...
     //   arrayList.add(new Algo(R.drawable.baseline_portrait_black_48, "Hide/Obscure Face", ObscureFaceActivity.class));
      ...
      //  arrayList.add(new Algo(R.drawable.baseline_portrait_black_48,"i am new ",MainActivity2.class));
